...
#define Angle_Calculate_Select_Soft 1     //软件计算角度
#define Angle_Calculate_Select_Hard 0     //硬件计算角度

#define CAR_PERIOD 5   // 中断服务时间片轮转周期
#define CAR_MOTION_PERIOD 20   //速度控制周期100ms
#define CAR_DIRECTION_PERIOD 2  //方向控制周期10ms
