...
{
    /***********************************速度计算************************************/
    speed_Start = (angle - Balance_Point) * P_ANGLE  + angle_dot * D_ANGLE ;  //直立时所要的速度
    ...
    /*************用所得到的对应角度的速度进行PWM控制********************/
    if(Speed_L <= 0)    //angle大于0，向后，小于0，向前
    {
    ...
    if(Speed_R <= 0)    //angle大于0，向后，小于0，向前
    {
