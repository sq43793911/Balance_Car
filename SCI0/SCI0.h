...
#ifndef SCI0_H        //if no define
#define SCI0_H        //define  即如果没有定义的话，则定义。。。。(防止其他函数多次调用此头文件时而重复定义)
...
//////////////////////////////////////////////////////////
extern int8u_t SCI0_SendChar(int8u_t Chr);
extern void  SCI0_SendChar1(int8u_t Chr);
extern int8u_t SCI0_RecvChar(int8u_t *Chr);
extern int8u_t SCI0_RecvChar1(void);
